...
### **_Scope Plane_**
- Thr priority for this project was to create a database of products and services where users could easily browse and purchase products and services and provide smooth CRUD functionality from the front-end of the site for Admin users to add, update and delete items as necessary with ease.
...
- The product info page is where the user can get further more detailed information on each product which displays the product description, price, and product features of what will be included in this service if purchased.
